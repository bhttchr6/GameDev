...
// uncomment for simple shader without camera movement
...
int main()
{
   ...
   std::cout << "Loaded " << vertexCoordinates.size() << " vertices." << std::endl;
   ...
   std::cout << "xMIn = " << objBBox.minBox.x<< " " << "yMin = " << objBBox.minBox.y<< " "  << "zMin = " << objBBox.minBox.z << std::endl;
   std::cout << "xMax = " << objBBox.maxBox.x<< " "  << "yMax = " << objBBox.maxBox.y<< " "  << "zMax = " << objBBox.maxBox.z << std::endl;

   // Scale the coordinates to be within -1 to 1
